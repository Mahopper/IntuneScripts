...
<#
    ...
    .DESCRIPTION
    Checks if KB4577586 is installed. If not, downloads and installs from MSU catalog, and then downloads and runs Adobe uninstaller. Can be packaged as IntuneWin application.
    If packaging as a Win32 app, use the Detection script in the repo for your custom detection script.
